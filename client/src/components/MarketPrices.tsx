              ...
              <Card key={index} data-testid={`card-price-${item.crop.toLowerCase().replace(' ', '-')}`}>
                <CardContent className="p-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <h4 className="font-medium mb-2">Price Prediction</h4>
                      ...
                      <div className="mt-2">
                        ...
                        >
                          {item.prediction.recommendation.toUpperCase()}
                        </Badge>
                      </div>
                    </div>

                    <div>
                      <h4 className="font-medium mb-2">Price Trend (Last 7 Days)</h4>
                  ...
                  <div className="mt-3 pt-3 border-t text-xs text-muted-foreground">
                    Last updated: <span data-testid={`text-updated-${index}`}>{item.lastUpdated}</span>
                  </div>
                </CardContent>
              </Card>
            ))}
